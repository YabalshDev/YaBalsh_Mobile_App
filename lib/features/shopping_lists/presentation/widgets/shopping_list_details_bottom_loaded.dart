  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ShoppingListDetailsCubit, ShoppingListDetailsState>(
      builder: (context, state) {
        return Column(
          mainAxisAlignment: getIt<AppSettingsService>().appConfig.appVersion !=
                  '2.0.0' // complete version align center
          ...
          children: [
            ...
            getIt<AppSettingsService>().appConfig.appVersion ==
                ...
                : const Spacer(),
            getIt<AppSettingsService>().appConfig.appVersion ==
                    '2.0.0' // complete version show nothing otherwise show button
                ? const SizedBox()
